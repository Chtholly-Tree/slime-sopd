...
EXP_NAME=${SLIME_SCRIPT_EXP_NAME:-"qwen3-vl-2b_teacher_qwen3.5-397b_virl_8gpus_bs64_len8k_gold_2.4"}
...
# ===== data / model =====
TRAIN_DATASET_PATH="/mnt/tidal-alsh01/dataset/redone/zengyu/video_search_multi_agent/TreeVGR/train_think_with_image.jsonl@[0:1024]"
TEST_DATASET_PATH="/mnt/tidal-alsh01/dataset/redone/zengyu/video_search_multi_agent/TreeVGR/test_think_with_image.jsonl@[0:10]"
...
JUDGE_URL="http://10.144.207.119:8001"
JUDGE_API_KEY="EMPTY"
...
RM_ARGS=(
   ...
   --custom-reward-post-process-path examples.think_with_image.multiturn_gold.post_process_rewards
