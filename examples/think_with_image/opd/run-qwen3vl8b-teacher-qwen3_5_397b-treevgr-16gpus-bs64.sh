...
EXP_NAME=${SLIME_SCRIPT_EXP_NAME:-"qwen3-vl-8b_teacher_qwen3.5-397b_treevgr_16gpus_bs64_kl"}
...
#    --eval-trace-save-dir "/mnt/tidal-alsh01/dataset/redone/zengyu/xikun/slime-2.4/examples/think_with_image/opd/log"
)
