...
# ===== experiment =====
EXP_NAME=${SLIME_SCRIPT_EXP_NAME:-"qwen3-vl-2B_teacher_qwen3.5-9B_virl_gold_32rollout_32train_2.4"}
...
# ===== data / model =====
TRAIN_DATA=${SLIME_SCRIPT_TRAIN_DATA:-"/mnt/tidal-alsh01/dataset/redone/zengyu/xikun/ViRL39K/train.parquet@[0:1000]"}
...
JUDGE_IP=${SLIME_SCRIPT_JUDGE_IP:-"10.144.202.95"}
JUDGE_PORT=${SLIME_SCRIPT_JUDGE_PORT:-13141}

# ===== rollout / checkpoint constants =====
ROLLOUT_BATCH_SIZE=${SLIME_SCRIPT_ROLLOUT_BATCH_SIZE:-1024}
N_SAMPLES_PER_PROMPT=${SLIME_SCRIPT_N_SAMPLES_PER_PROMPT:-8}
GLOBAL_BATCH_SIZE=${SLIME_SCRIPT_GLOBAL_BATCH_SIZE:-2048}
