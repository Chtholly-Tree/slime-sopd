...
def extract_teacher_response_triplets(teacher_result: dict, prompt_len: int, response_len: int) -> list[list]:
...
def prepare_teacher_log_probs(args: Any, sample: Sample, teacher_result: dict) -> torch.Tensor:
    ...
    teacher_triplets = extract_teacher_response_triplets(teacher_result, teacher_prompt_len, teacher_response_len)
