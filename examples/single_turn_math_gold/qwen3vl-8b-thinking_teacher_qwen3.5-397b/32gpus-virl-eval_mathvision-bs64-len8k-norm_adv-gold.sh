...
EXP_NAME=${SLIME_SCRIPT_EXP_NAME:-"qwen3-vl-8b-thinking_teacher_qwen3.5-397b_virl_eval-mathvision_32gpus_bs64_len8k_norm-adv_gold_2.4"}
...
EVAL_DATA=${SLIME_SCRIPT_EVAL_DATA:-"/mnt/tidal-alsh01/dataset/redone/zengyu/xikun/MathVision/testmini.parquet"}
...
EVAL_ARGS=(
   --eval-interval 10
   --eval-prompt-data mathvision ${EVAL_DATA}
